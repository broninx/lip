...
let%test "zero_one_same_2" = derive same_amount [1;2;5] |> to_string = "1001"
let%test "zero_one_same_3" = derive same_amount [1;1;3;5;5] |> to_string = "00110101"
let%test "zero_one_same_4" = derive same_amount [2;3;2;5;5] |> to_string = "10001110"
